...
const content = {
  zh: {
    notTitle: "先排雷：MirrorPost 不是什么",
    notItems: ["简单的公众号运营", "帮忙写点宣传文案", "流量导向/标题党", "外包式 Marketing", "短期热点追逐", "无脑搬运工"],
    coreTitle: "真正要做的三件事",
    tasks: [
      {
        id: 1,
        title: "1. 把「真实过程」变成「可信内容」",
        desc: "WhiteMirror 的最大优势是真实发生的事情很多。MirrorPost 的工作是把这些真实过程结构化，让外部人看得懂。",
        tag: "不是编故事，是翻译现实",
      },
      {
        id: 2,
        title: "2. 建立 WhiteMirror 的「长期信用」",
        desc: "让外界看到我们的连续性和可追溯性。让每一次新合作、招生、科研，都“站在过去的积累上”。",
        badgeLabel: "Asset Value",
        badgeValue: "Long-term Trust",
      },
      {
        id: 3,
        title: "3. 服务「招生 / 合作 / 招人」的底层支撑",
        desc: "学生、老师、合作方为什么信你？答案不是一句 pitch，而是他们在你过往内容中已经看懂你是谁了。",
        tag: "转化的信任基石",
      }
    ]
  },
  en: {
    notTitle: "First, what MirrorPost is NOT",
    notItems: ["Basic WeChat ops", "Writing promo copy on demand", "Traffic-first clickbait", "Outsourced marketing", "Chasing short-term hype", "Mindless reposting"],
    coreTitle: "The Three Core Missions",
    tasks: [
      {
        id: 1,
        title: "1. Turn real process into credible content",
        desc: "WhiteMirror's advantage is the volume of real things happening. MirrorPost structures those processes so outsiders can understand them.",
        tag: "Not storytelling, but translating reality",
      },
      {
        id: 2,
        title: "2. Build long-term credibility for WhiteMirror",
        desc: "Let the outside see continuity and traceability. Every collaboration, cohort, and research stands on accumulated history.",
        badgeLabel: "Asset Value",
        badgeValue: "Long-term Trust",
      },
      {
        id: 3,
        title: "3. Support the foundation for recruiting, partners, and hiring",
        desc: "Why would students, teachers, and partners trust you? Not from a single pitch, but from understanding who you are through your past work.",
        tag: "Trust that converts",
      }
    ]
  }
};

export function PostCore({ language }: { language: Language }) {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-24 overflow-hidden relative">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-2xl font-bold text-black">{t.notTitle}</h2>
          </div>
          ...
          <div className="flex overflow-hidden group">
            ...
            >
              {[...t.notItems, ...t.notItems, ...t.notItems].map((item, i) => (
        ...
        <div>
          <h2 className="text-5xl font-bold text-black mb-16 tracking-tight">{t.coreTitle}</h2>
          <div className="grid md:grid-cols-3 gap-6 auto-rows-[minmax(300px,auto)]">
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-3xl font-bold mb-4">{t.tasks[0].title}</h3>
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col">
                ...
                <h3 className="text-3xl font-bold mb-6">{t.tasks[1].title}</h3>
                ...
                <div className="p-6 bg-white rounded-2xl border border-black/5 shadow-sm">
                  <div className="text-xs text-slate-400 uppercase tracking-wider mb-2">{t.tasks[1].badgeLabel}</div>
                  <div className="text-2xl font-bold text-black">{t.tasks[1].badgeValue}</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center h-full">
                <div className="flex-1">
                  ...
                  <h3 className="text-2xl font-bold mb-4">{t.tasks[2].title}</h3>
