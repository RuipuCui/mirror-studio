...
const content = {
  ...
  en: {
    badge: "Live Signal Monitoring",
    title: "Scanning the Frontier",
    desc: (
      <>
        We don't just read papers. We actively scan emerging patterns.<br/>
        Our research engine constantly tunes its frequency to catch weak signals before the industry shifts.
      </>
    ),
    signals: [
      { id: 1, label: "Agentic Patterns", status: "Detected", angle: 45, delay: 0 },
      { id: 2, label: "Multimodal Interaction", status: "Tracking", angle: 120, delay: 1 },
...
export function ResearchRadar({ language }: { language: Language }) {
