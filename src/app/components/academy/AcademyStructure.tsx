    ...
    <section className="py-24 px-6 relative border-t border-black/5 bg-slate-50/50">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          {/* Tasks */}
          <div>
            <h2 className="text-3xl font-bold text-black mb-8">学员做什么？</h2>
          ...
          {/* Mentors */}
          <div>
            <h2 className="text-3xl font-bold text-black mb-8">导师做什么？</h2>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
            ...
            >
              <div className="relative z-10">
                ...
                <p className="text-white/80 text-lg mb-8">
                  Mirror Academy 的导师，更像 <span className="font-bold text-white">CTO / Tech Lead / PM</span>，而不是讲课的老师。
                </p>
